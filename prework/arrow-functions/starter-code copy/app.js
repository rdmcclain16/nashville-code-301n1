...
// TODO: Uncomment the following line of code to see the output in the browser console
// sconsole.log('As a one-liner:', oneLiner('Code 301'));
...
let sumAndProduct = (a, b) => `${a + b} and ${a * b}`
...
// arow functions are not constructor functions in the sense that you cannot use 'this' in arrow functions in order to call a particular property. no need to use 'new' as they are builder functions instead of constructor.
...
// this oject window is what is invoked when console logged.
//
// 2. What is "this" when joe.scopeArrow() is invoked?
// an array
//
// 3. Explain why "this" is different when an arrow function is used.
// this is not tied to a constructor function, therefore calling whatever the identified property of that regular function. Instead this is used inside an arrow function in relation to its parent. 
//
